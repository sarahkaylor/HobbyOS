/* HobbyOS sysroot: <stdint.h> — fixed-width integer types.
 *
 * Types come from the compiler's builtin macros so the same header is
 * correct on both supported architectures (aarch64 / x86_64 LP64).
 */
#ifndef HOBBYOS_STDINT_H
#define HOBBYOS_STDINT_H 1
