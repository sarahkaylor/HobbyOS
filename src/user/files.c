/*
 * files.c - Files for HobbyOS.
 *
 * File manager: browse the FAT-16 filesystem, create/rename/delete, run programs.
 *
 ...
 * host unit test includes this file with `#define main files_app_main`.
 *
