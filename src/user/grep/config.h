...
/* #undef HAVE_BTOWC */ /* drops WIDE_CHAR_SUPPORT in the vendored regex. */
...
/* #undef HAVE_LIBINTL_H */ /* no NLS in the sysroot. */
...
/* #undef HAVE_MEMPCPY */ /* no glibc __mempcpy. */

/* Define to 1 if you have a working `mmap' system call. */
/* #undef HAVE_MMAP */ /* HobbyOS has no mmap; keep the read() path. */
...
/* #undef HAVE_STRERROR_R */ /* sysroot ships strerror() only. */
...
/* #undef HAVE_WCRTOMB */ /* no multibyte conversion in the sysroot: keeps MBS_SUPPORT off. */
...
/* #undef malloc */ /* the sysroot malloc is the real one. */
...
/* #undef realloc */ /* the sysroot realloc is the real one. */
