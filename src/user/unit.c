...
static const struct unit_def units_length[] = { {"mm", 1000LL}, {"cm", 10000LL}, {"m", 1000000LL}, {"km", 1000000000LL}, {"in", 25400LL}, {"ft", 304800LL}, {"mi", 1609344000LL},
};

static const struct unit_def units_mass[] = { {"mg", 1000LL}, {"g", 1000000LL}, {"kg", 1000000000LL}, {"oz", 28349523LL}, {"lb", 453592370LL},
};

static const struct unit_def units_time[] = { {"s", 1000000LL}, {"min", 60000000LL}, {"h", 3600000000LL}, {"day", 86400000000LL},
};

static const struct unit_def units_data[] = { {"B", 1000000LL}, {"KB", 1024000000LL}, {"MB", 1048576000000LL}, {"GB", 1073741824000000LL},
};
...
static const struct unit_def units_temp[] = { {"C", 1LL}, {"F", 1LL}, {"K", 1LL},
};

static const struct unit_cat g_cats[NUM_CATS] = { {"Length",      units_length, 7, 0}, {"Mass",        units_mass,   5, 0}, {"Time",        units_time,   4, 0}, {"Data",        units_data,   4, 0}, {"Temperature", units_temp,   3, 1},
};
