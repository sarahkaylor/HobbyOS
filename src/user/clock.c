/*
 * clock.c - Clock for HobbyOS.
 *
 * Clock & calendar: live RTC time (sysinfo cmd 6) and a month calendar view.
 *
 ...
 * host unit test includes this file with `#define main clock_app_main`.
 *
