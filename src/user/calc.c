/*
 * calc.c - Calc for HobbyOS.
 *
 * Calculator: 64-bit integer arithmetic with an on-screen clickable keypad.
 *
 ...
 * host unit test includes this file with `#define main calc_app_main`.
 *
