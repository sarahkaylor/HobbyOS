/*
 * sysmon.c - SysMon for HobbyOS.
 *
 * System monitor: live CPU/memory bars and a process list with kill action.
 *
 ...
 * host unit test includes this file with `#define main sysmon_app_main`.
 *
