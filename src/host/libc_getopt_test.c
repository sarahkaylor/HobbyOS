...
static struct option const longopts[] = {
    ...
    {"delta", no_argument, &flag_storage, 'd'},
    {"delta2", no_argument, NULL, 'D'},
    {"break", no_argument, NULL, 'k'},
    {NULL, 0, NULL, 0}
};
...
static struct scen scens[] = {
    {"plain short", {"p", "-a", "-b"}, "ab", 0},
    {"cluster", {"p", "-abc", "x"}, "abc", 0},
    {"cluster+arg", {"p", "-abV", "x"}, "abV:", 0},
    {"short=value", {"p", "-bval"}, "b:", 0},
    {"short=space arg", {"p", "-b", "val"}, "b:", 0},
    {"missing arg ?", {"p", "-b"}, "b:", 0},
    {"missing arg :", {"p", "-b"}, ":b:", 0},
    {"optional same-cluster", {"p", "-bval"}, "b::", 0},
    {"optional next-arg", {"p", "-b", "val"}, "b::", 0},
    {"unknown short", {"p", "-z"}, "ab", 0},
    {"appear-trailing after opt", {"p", "-a", "--"}, "a", 0},
    {"long simple", {"p", "--alpha"}, "", 1},
    {"long =arg", {"p", "--beta", "v"}, "", 1},
    {"long =val", {"p", "--beta=v"}, "", 1},
    {"long abbreviation", {"p", "--alp"}, "", 1},
    {"long ambiguous", {"p", "--d"}, "", 1},
    {"long exact beats prefix", {"p", "--delta"}, "", 1},
    {"long no-arg with value", {"p", "--alpa=x"}, "", 1},
    {"long unknown", {"p", "--nope"}, "", 1},
    {"long missing arg ?", {"p", "--beta"}, "", 1},
    {"long missing arg :", {"p", "--beta"}, ":b:", 1},
    {"long optional", {"p", "--gamma", "x"}, "", 1},
    {"long optional =", {"p", "--gamma=x"}, "", 1},
    {"dashdash", {"p", "--", "-a"}, "a", 0},
    {"dashdash long", {"p", "--alpha", "--", "x"}, "", 1},
    {"permute non-opt", {"p", "file", "-a"}, "a", 0},
    {"permute several", {"p", "f1", "f2", "-a", "-b"}, "ab", 0},
    {"posix + stops at non-opt", {"p", "file", "-a"}, "+a", 0},
    {"leading - returns arg", {"p", "file", "-a"}, "-a", 0},
    {"short then long", {"p", "-a", "--beta", "v"}, "a", 1},
    {"unknown short in cluster", {"p", "-az"}, "a", 0},
    {"long flag abrev", {"p", "--del"}, "", 1},
    {"after long, short cluster", {"p", "--alpha", "-ab", "x"}, "ab", 1},
};
